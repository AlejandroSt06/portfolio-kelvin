...
function Experience() {
    ...
    return (
        <div className='experience my-5 py-1'>
...
function AboutSection() {
    ...
    return (
        <section id="about" className='py-lg-5 mt-lg-5'>
            <div className="container pt-3 pt-lg-3 mt-5 ">
                <h2 className='text-center'>About Me</h2>
                <p className='text-center'>Here you will find more information about me and what I do</p>
            </div>
            <div className='ps-3'>
                <div className= "d-flex flex-column flex-lg-row  g-5 py-lg-5 mt-lg-5 justify-content-center">

                    <div className="col-10 col-sm-8 col-lg-6">
                        <img
                            src="\avatar-kelvin.jpeg"
                            className="about-image d-block mx-lg-auto img-fluid about-image my-4"
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-start mt-1">
                            <button class="button" type="button">
                                <a href='\CV - Kelvin Enrique  Saavedra Toala (Aprile2023) 3.pdf' download="Kelvin Saavedra Cv" >
